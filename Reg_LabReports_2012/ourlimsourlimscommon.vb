Public Class OurLIMSCommon
    ...
    ' zz need to have field/label/property for formatted_result, study, and other parent properties for aliquots (can create field label and then when creating aliquots in that case crate the parent object and set the property
    ' zz replace column name/label properties with constants to reduce code
#Region "COM GUIDs"
...
#End Region
    ...
    Public Sub New()
        ...
        ConditionsNotStableSampleNRCodes.Add("Acceptable", RESULT_CODE_NR_NOT_STABLE)
        ConditionsNotStableSampleNRCodes.Add("Acceptable(-Discrepancy)", RESULT_CODE_NR_NOT_STABLE)
        ConditionsNotStableSampleNRCodes.Add("Acceptable-Flag", RESULT_CODE_NR_NOT_STABLE)
        ConditionsNotStableSampleNRCodes.Add("Acceptable-Resolved", RESULT_CODE_NR_NOT_STABLE)
        ConditionsNotStableSampleNRCodes.Add("Acceptable-Resolved Flag", RESULT_CODE_NR_NOT_STABLE)
        ConditionsNotStableSampleNRCodes.Add("Acceptable-Un-quarantined", RESULT_CODE_NR_NOT_STABLE)
        ...
        LogFileUpdate("creating NR codes")
        NRCodesDescriptions = New Hashtable
        ' ADD in reverse sort order
        NRCodesDescriptions.Add("6", "No corresponding PK result")
        ...
        LogFileUpdate("creating NR codes " & NRCodesAndDescriptions.Count)
    ...
    Public Const RESULT_CODE_NR_NOT_STABLE = "1"
    Public Const RESULT_CODE_NR_NO_PK_SOP_RESULT = "6"
    ...
    Public ReadOnly Property NRCodesAndDescriptions() As Hashtable
        Get
            LogFileUpdate("get NR codes property")
            LogFileUpdate("get NR codes property " & NRCodesDescriptions.Count)
    ...
    Public ReadOnly Property FormattedResultNoResult() As String
        ...
        End Get
    End Property
    Public ReadOnly Property ResultCodeNRNotStable() As String
        Get
            Return RESULT_CODE_NR_NOT_STABLE
        End Get
    End Property
    Public ReadOnly Property NRCodeNoPKSOPResult() As String
        Get
            Return RESULT_CODE_NR_NO_PK_SOP_RESULT
        End Get
    End Property
    ...
    Public ReadOnly Property FIELD_LABEL_STD_NOMINAL() As String
        ...
        End Get
    End Property
    Public ReadOnly Property FIELD_LABEL_PQC() As String
        Get
            Return "PQC"
        End Get
    End Property
    Public ReadOnly Property FIELD_LABEL_PQC_NOMINAL() As String
        Get
            Return "PQC_NOMINAL"
        End Get
    End Property
    Public ReadOnly Property FIELD_LABEL_HLQC() As String
        Get
            Return "HLQC"
        End Get
    End Property
    Public ReadOnly Property FIELD_LABEL_HLQC_NOMINAL() As String
        Get
            Return "HLQC_NOMINAL"
        End Get
    End Property
